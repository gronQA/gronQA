...
const Logo: FC<LogoProps> = ({ className = "" }) => {
  ...
  const handleMouseMove = (e: MouseEvent) => {
    ...
    x.set((clientX - (left + width / 2)) / 8);
    y.set((clientY - (top + height / 2)) / 8);
  };
      ...
      >
        ...
        >
          ...
          <motion.path
            ...
            style={{ fill: isHovered && !isMobile ? brandGreen : white }}
          ...
          <motion.polygon
            style={{ fill: brandGreen, willChange: 'clip-path, opacity' }}
            points="600,298.78 464.68,380.75 404.61,331.53 458.25,428.64 "
            transform="translate(-392.31495,-298.78)"
            initial={isMobile ? { opacity: 1, clipPath: 'inset(0 0% 0 0)' } : { opacity: 0, clipPath: 'inset(0 100% 0 0)' }}
          ...
          <motion.text
            ...
            style={{ 
              fill: isHovered && !isMobile ? brandGreen : white,
              fontSize: '124px',
              letterSpacing: '-7px'
            }}
            x="146"
